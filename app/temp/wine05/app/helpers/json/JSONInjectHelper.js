...
var JSONInjectHelper = (function () {
	...
	return {
		...
		addAttribute : function(aCollection, attribName, attribValue) {
		...
		addAttributeWith2Attributes : function(aCollection, attribName, attribValue, secondArray, secondAttrib) {
			_.each(aCollection, function(item, i) {
